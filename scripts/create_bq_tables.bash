...
bq mkdef --noautodetect --source_format=NEWLINE_DELIMITED_JSON "gs://meetup_data/open_events/*.json" ../bq_table_schema/event_comments.json > event_comments_tdf.json
